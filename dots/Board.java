...
public class Board {
     ...
     * (represented by an int). This method should throw an IllegalArgumentException.
     * if the argument SIZE is not within the MINSIZE and MAXSIZE inclusve. This 
     * constructor will only be called once per game session. Initialize any variables
     * if needed here.
     */
